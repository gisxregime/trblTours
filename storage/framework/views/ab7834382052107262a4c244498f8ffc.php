        ...
        <header :class="scrolled ? 'nav-shell scrolled' : 'nav-shell'" class="fixed inset-x-0 top-0 z-50 border-b border-[#ddd2bd]">
            <div class="mx-auto flex max-w-[1260px] items-center justify-between px-6 py-4">
                ...
                <nav class="hidden items-center gap-10 md:flex">
                    <a href="<?php echo e(route('dashboard.tourist')); ?>" class="top-nav-link <?php echo e(request()->routeIs('dashboard.tourist') ? 'active' : ''); ?>">Explore Tours</a>
                    <a href="<?php echo e(route('dashboard.my-posts')); ?>" class="top-nav-link <?php echo e(request()->routeIs('dashboard.my-posts') ? 'active' : ''); ?>">My Posts</a>
                </nav>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3567483390-0', $__key);
...
[$__name, $__params] = $__split('explore-tours-feed', ['context' => 'dashboard']);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3567483390-1', $__key);
