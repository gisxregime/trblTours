...
<head>
    ...
    <title><?php echo e(config('app.name', 'TrblTours')); ?> | About & How It Works</title>
...
<body>
    <header class="site-header">
        <div class="container header-inner">
            <a href="<?php echo e(route('dashboard')); ?>" class="brand" aria-label="Trbltours home">
                <img src="<?php echo e(asset('images/tribaltours_icon.png')); ?>" alt="Trbltours" class="brand-logo">
                <span class="brand-font brand-name">Trbltours</span>
            </a>

            <nav class="header-nav" aria-label="Primary navigation">
                <a href="<?php echo e(route('explore-tours')); ?>" class="header-link">Explore Tours</a>
                <a href="#" class="header-link">Become a Guide</a>
                <a href="<?php echo e(route('how-it-works')); ?>" class="header-link">How It Works</a>
            ...
            <div class="header-actions">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-light">Log In</a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-solid">Sign Up</a>
            </div>
        </div>
    </header>
...
<?php /**PATH /home/mistah-regime/tribaltours/resources/views/how-it-works.blade.php ENDPATH**/ ?>