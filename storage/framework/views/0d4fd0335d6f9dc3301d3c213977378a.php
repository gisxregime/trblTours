                        ...
                        <form method="POST" action="<?php echo e(route('bookings.store')); ?>" class="booking-card">
                            ...
                            <div class="booking-field">
                                ...
                                <select id="bookingDate" name="booking_date" required>
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $dateOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dateOption); ?>" <?php if(old('booking_date') === $dateOption): echo 'selected'; endif; ?>>
                                            <?php echo e(\Illuminate\Support\Carbon::parse($dateOption)->format('M d, Y')); ?>
