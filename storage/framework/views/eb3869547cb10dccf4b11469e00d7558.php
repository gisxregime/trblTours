...
<body class="min-h-screen bg-[#f5efe2] font-inter text-[#3e2a1f]">
    ...
    <div
        x-data="guideListingBuilder({
            initialTab: <?php echo \Illuminate\Support\Js::from($activeTab)->toHtml() ?>,
            guideName: <?php echo \Illuminate\Support\Js::from($guideDisplayName)->toHtml() ?>,
            guideBio: <?php echo \Illuminate\Support\Js::from($guideBioDefault)->toHtml() ?>,
            guideAvatarUrl: <?php echo \Illuminate\Support\Js::from($guideAvatarUrl)->toHtml() ?>,
            regionOptions: <?php echo \Illuminate\Support\Js::from($regionOptions)->toHtml() ?>,
            cityOptions: <?php echo \Illuminate\Support\Js::from($cityOptions)->toHtml() ?>
        })"
        x-init="init()"
    >
        <header :class="scrolled ? 'nav-shell scrolled' : 'nav-shell'" class="fixed inset-x-0 top-0 z-50 border-b border-[#ddd2bd]">
            <div class="mx-auto flex max-w-[1260px] items-center justify-between px-6 py-4">
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2.5">
                    <img src="<?php echo e(asset('images/tribaltours_icon.png')); ?>" alt="TrblTours Icon" class="h-9 w-9 rounded-full border border-[#d3c5aa]/70 bg-[#f7efdd] object-cover">
...
[$__name, $__params] = $__split('tourist-notifications', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-628370441-0', $__key);
...
?>
                    ...
                    <div x-cloak x-show="menuOpen" x-transition class="absolute right-0 top-full mt-2 w-56 overflow-hidden rounded-2xl border border-[#d8c7a9] bg-[#fffaf2] py-2 shadow-2xl">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm text-[#5a3c2a] transition hover:bg-[#f7ecd7]">
                            <i class="fa-solid fa-user w-4 text-center"></i>
                            <span>Profile</span>
                        </a>
                        <a href="<?php echo e(route('dashboard.guide')); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm text-[#5a3c2a] transition hover:bg-[#f7ecd7]">
                            <i class="fa-solid fa-compass w-4 text-center"></i>
                            <span>Dashboard</span>
                        </a>
                        <a href="<?php echo e(route('dashboard.messages')); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm text-[#5a3c2a] transition hover:bg-[#f7ecd7]">
                            <i class="fa-solid fa-envelope w-4 text-center"></i>
                            <span>Messages</span>
                        </a>
                        <a href="<?php echo e(route('settings.edit')); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm text-[#5a3c2a] transition hover:bg-[#f7ecd7]">
        ...
        <main class="mx-auto max-w-[1260px] px-4 pb-28 pt-[118px] sm:px-6 lg:px-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_string($firstValidationError) && $firstValidationError !== ''): ?>
                <div class="mb-5 rounded-2xl border border-[#f2b8b1] bg-[#fdeeed] px-4 py-3 text-sm font-semibold text-[#8d2d21]">
                    <?php echo e($firstValidationError); ?>
            ...
            <section x-cloak x-show="activeTab === 'requests'" class="space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requestPosts->isEmpty()): ?>
                ...
                <?php else: ?>
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $requestPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <article id="request-<?php echo e($post->id); ?>" class="request-shell overflow-hidden" x-data="{ openComments: false }">
                                <div class="p-5 sm:p-6">
                                    <div class="flex flex-wrap items-start justify-between gap-3">
                                        <div class="flex items-start gap-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($touristAvatar): ?>
                                                <img src="<?php echo e($touristAvatar); ?>" alt="<?php echo e($touristName); ?>" class="h-10 w-10 rounded-full border border-[#d7c8ad] object-cover">
                                            <?php else: ?>
                                                <span class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#d7c8ad] bg-[#f4e7d1] text-xs font-bold text-[#5f4a36]">
                                                    <?php echo e(strtoupper(substr($touristName, 0, 1))); ?>

                                                </span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div>
                                                <p class="text-sm font-semibold uppercase tracking-[0.08em] text-[#7f6b57]"><?php echo e($touristName); ?></p>
                                                <h2 class="mt-1 text-xl font-bold text-[#3f2d22]"><?php echo e($post->title ?: 'Untitled Request'); ?></h2>
                                                <p class="mt-1 text-sm text-[#726051]"><?php echo e($post->location ?: 'Philippines'); ?> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->region): ?> • <?php echo e($post->region); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></p>
                                            </div>
                                        </div>

                                        <span class="status-pill <?php echo e(strtolower((string) $post->status) === 'open' ? 'bg-[#edf4e6] text-[#385032]' : 'bg-[#f1e6d4] text-[#6a5644]'); ?>">
                                            <?php echo e(ucfirst(str_replace('_', ' ', (string) ($post->status ?: 'open')))); ?>
                                    ...
                                    <dl class="mt-4 grid grid-cols-2 gap-3 text-sm sm:grid-cols-4">
                                        <div class="rounded-xl border border-[#e8dbc3] bg-[#fff8ec] p-2.5">
                                            ...
                                            <dd class="mt-1 font-semibold text-[#4f3d31]"><?php echo e($post->duration ?: 'Flexible'); ?></dd>
                                        </div>
                                        <div class="rounded-xl border border-[#e8dbc3] bg-[#fff8ec] p-2.5">
                                            <dt class="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#7f6b57]">Budget</dt>
                                            <dd class="mt-1 font-semibold text-[#4f3d31]">₱ <?php echo e(number_format((float) ($post->budget_max ?? $post->budget_min ?? 0), 0)); ?></dd>
                                        </div>
                                        <div class="rounded-xl border border-[#e8dbc3] bg-[#fff8ec] p-2.5">
                                            <dt class="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#7f6b57]">Travelers</dt>
                                            <dd class="mt-1 font-semibold text-[#4f3d31]"><?php echo e((int) ($post->adults ?? 0)); ?> Adults / <?php echo e((int) ($post->children ?? 0)); ?> Children</dd>
                                        </div>
                                        <div class="rounded-xl border border-[#e8dbc3] bg-[#fff8ec] p-2.5">
                                            <dt class="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#7f6b57]">Preferred Date</dt>
                                            <dd class="mt-1 font-semibold text-[#4f3d31]"><?php echo e($preferredDate); ?></dd>
                                        </div>
                                    </dl>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="mt-2 flex flex-wrap gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $interestList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $interest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <span class="rounded-full border border-[#d8c8ac] bg-[#f8eedc] px-2.5 py-1 text-xs font-semibold text-[#5f4d3f]"><?php echo e($interest); ?></span>
                                    ...
                                    <p class="mt-4 text-sm text-[#6f5d52]"><?php echo e($post->description ?: $post->message); ?></p>

                                    <div class="mt-4 flex flex-wrap items-center justify-between gap-3">
                                        <p class="text-xs text-[#8a7662]">Posted: <?php echo e($post->created_at?->format('M j, Y, g:i A')); ?></p>
                                        <button type="button" @click="openComments = !openComments" class="inline-flex items-center rounded-full border border-[#d8c7a9] bg-[#fff4df] px-3 py-1.5 text-xs font-semibold text-[#5f4a36] transition hover:bg-[#f4e4ca]">
                                            ...
                                            View Comments (<?php echo e((int) $post->comments_count); ?>)
                                        </button>
                                    </div>
                                </div>
                                ...
                                <section x-cloak x-show="openComments" x-transition class="border-t border-[#ecdfc8] bg-[#fffaf1] p-4 sm:p-5">
                                    <div class="space-y-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $post->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <article class="rounded-xl border border-[#e3d4bc] bg-white p-3">
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($commenterAvatar): ?>
                                                        <img src="<?php echo e($commenterAvatar); ?>" alt="<?php echo e($commenterName); ?>" class="h-9 w-9 rounded-full border border-[#d7c8ad] object-cover">
                                                    <?php else: ?>
                                                        <span class="inline-flex h-9 w-9 items-center justify-center rounded-full border border-[#d7c8ad] bg-[#f4e7d1] text-xs font-bold text-[#5f4a36]"><?php echo e(strtoupper(substr($commenterName, 0, 1))); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <div class="min-w-0 flex-1">
                                                        <div class="flex flex-wrap items-center gap-2">
                                                            <p class="text-sm font-bold text-[#3f2d22]"><?php echo e($commenterName); ?></p>
                                                            <span class="text-[11px] text-[#8a7764]"><?php echo e($comment->created_at?->diffForHumans()); ?></span>
                                                        </div>
                                                        <p class="mt-1 text-sm text-[#654f3f]"><?php echo e($comment->body); ?></p>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->offer_price !== null): ?>
                                                            <p class="mt-1 text-xs font-bold text-[#3f2d22]">Offered Price: ₱<?php echo e(number_format((float) $comment->offer_price, 0)); ?></p>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                </div>
                                            </article>
                                    ...
                                    <form action="<?php echo e(route('dashboard.guide.request-posts.comments.store', $post)); ?>" method="POST" class="mt-4 rounded-xl border border-[#dfceb3] bg-[#fffdf8] p-3">
                                        <?php echo csrf_field(); ?>
            ...
            <section x-cloak x-show="activeTab === 'listings'" class="space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($guideListings->isEmpty()): ?>
                    <div class="rounded-2xl border border-dashed border-[#d8c9af] bg-[#fff8ec] p-8 text-center">
                        <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#efe2cb] text-[#7a654f]">
                ...
                <?php else: ?>
                    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $guideListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <article class="listing-card flex flex-col overflow-hidden">
                                <div class="relative h-[176px] w-full">
                                    <img src="<?php echo e($thumbnailUrl); ?>" class="h-full w-full object-cover" alt="<?php echo e($listing->title ?: $listing->name); ?>">
                                    <span class="absolute right-3 top-3 status-pill <?php echo e($status === 'active' ? 'bg-[#edf4e6] text-[#385032]' : 'bg-[#f1e6d4] text-[#6a5644]'); ?>">
                                ...
                                <div class="flex flex-1 flex-col px-4 pb-4 pt-3">
                                    <h3 class="text-[20px] font-semibold leading-tight text-[#5f5447]"><?php echo e($listing->title ?: $listing->name); ?></h3>
                                    <p class="mt-1 text-[12px] font-semibold text-[#9b8f7c]"><?php echo e($listing->region ?: 'Philippines'); ?></p>

                                    <div class="mt-3 grid gap-2 text-[11px] text-[#8e8374]">
                                        <div class="flex items-center gap-2">
                                            <i class="fa-regular fa-clock w-3 text-center text-[#8f8475]"></i>
                                            <span><?php echo e($durationLabel); ?></span>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <i class="fa-solid fa-user-group w-3 text-center text-[#8f8475]"></i>
                                            <span><?php echo e($maxPax); ?> pax</span>
                                        </div>
                                        <div class="flex items-center gap-2">
                                    ...
                                    <a href="<?php echo e(route('tours.show', ['tour' => $listing, 'from' => 'dashboard'])); ?>" class="mt-3 inline-flex items-center justify-center rounded-lg border border-[#4f7740] bg-[#5f8a46] px-2 py-2 text-xs font-semibold text-[#f7fff4] transition hover:bg-[#4f7740]">
                                        Open Full Listing Page
                                    </a>

                                    <div class="mt-3 grid grid-cols-3 gap-2">
                                        <a href="<?php echo e(route('dashboard.guide.tours', ['edit' => $listing->id])); ?>" class="inline-flex items-center justify-center rounded-lg border border-[#d4a563]/45 bg-[#fff7ec] px-2 py-2 text-xs font-semibold text-[#7a5532] transition hover:bg-[#f7ead7]">Edit</a>
                                        <form method="POST" action="<?php echo e(route('dashboard.guide.listings.destroy', $listing)); ?>">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <a href="<?php echo e(route('dashboard.guide.requests')); ?>" class="inline-flex items-center justify-center rounded-lg border border-[#4f7740] bg-[#5f8a46] px-2 py-2 text-xs font-semibold text-[#f7fff4] transition hover:bg-[#4f7740]">View Bookings</a>
                                    </div>
                                </div>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        >
            <section class="max-h-[94vh] w-full max-w-7xl overflow-y-auto rounded-3xl border border-[#eadfcd] bg-white p-5 shadow-[0_24px_56px_rgba(63,45,34,0.32)] sm:p-6" @click.outside="closeCreateListingModal()">
                ...
                <div class="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(360px,0.8fr)]">
                    <form action="<?php echo e(route('dashboard.guide.listings.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                        <?php echo csrf_field(); ?>
