<x-app-layout>
    <div x-data="dashboardMessages({
        ...
        selectedConversation: @js($selectedConversation),
        selectedMessages: @js($selectedMessages),
        showUrlTemplate: @js(route('dashboard.messages.show', ['conversation' => '__conversation__'])),
        storeUrlTemplate: @js(route('dashboard.messages.store', ['conversation' => '__conversation__'])),
        readUrlTemplate: @js(route('dashboard.messages.read', ['conversation' => '__conversation__'])),
