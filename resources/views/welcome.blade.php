    ...
    <header class="site-header">
        <div class="container header-inner">
            ...
            <nav class="header-nav" aria-label="Primary navigation">
                <a href="{{ route('explore-tours') }}">Explore Tours</a>
    ...
    <main>
        <section class="hero">
            <div class="hero-background">
                <div class="hero-carousel" id="heroCarousel">
                    <div class="hero-slide active"><img src="{{ asset('hero/caoursel1.webp') }}"
                            alt="Philippine island landscape"></div>
                    <div class="hero-slide"><img src="{{ asset('hero/carousel2.jpg') }}"
                            alt="Philippine local destination"></div>
                    <div class="hero-slide"><img src="{{ asset('hero/carousel3.jpg') }}" alt="Philippine scenic spot">
                    </div>
                    <div class="hero-slide"><img src="{{ asset('hero/carousel4.jpg') }}" alt="Philippine coastline">
                    </div>
                    <div class="hero-slide"><img src="{{ asset('hero/carousel5.jpg') }}" alt="Philippine island tour">
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="hero-note-cta">
                            ...
                            <div class="hero-cta-actions">
                                <a class="btn hero-cta hero-cta-primary" href="{{ route('explore-tours') }}">View All Tours</a>
                        ...
                        <div class="favorites-grid" id="favoritesCarousel">
                            <article class="favorite-card active">
                                <div class="favorite-card-image"
                                    style="background-image: url('{{ asset('hero/elnido.jpg') }}');"></div>
                            ...
                            <article class="favorite-card">
                                <div class="favorite-card-image"
                                    style="background-image: url('{{ asset('hero/palawan.jpg') }}');"></div>
                                <div class="favorite-card-body">
                            ...
                            <article class="favorite-card">
                                <div class="favorite-card-image"
                                    style="background-image: url('{{ asset('hero/batad.jpg') }}');"></div>
                                <div class="favorite-card-body">
                                    <h6>Trip to Batad</h6>
                                </div>
                            </article>
        ...
        <section id="tours" class="tours">
            <div class="container">
                ...
                <livewire:explore-tours-feed context="home" />
            </div>
        </section>
        ...
        <section class="roles-cta">
            <div class="container roles-cta-grid">
                <article class="roles-cta-card">
                    <img class="roles-cta-media" src="{{ asset('images/tourist.png') }}"
                    ...
                    <a class="roles-cta-button primary" href="{{ route('signup.start') }}">Match me with a local
                        guide -></a>
                </article>
                <article class="roles-cta-card">
                    <img class="roles-cta-media" src="{{ asset('images/tourguide.jpg') }}"
                    ...
                    <p>I know my hometown like the back of my hand. I want to share my stories and hidden spots and earn
                        from what I love.</p>
                    <a class="roles-cta-button ghost" href="{{ route('signup.start') }}">Apply to showcase my
                        hometown -></a>
                </article>
            </div>
        </section>
            ...
            <div class="footer-top">
                <section class="footer-col">
                    <div class="footer-brand-head">
                        <img class="footer-brand-logo" src="{{ asset('images/tribaltours_icon.png') }}"
                            alt="Trbltours">
                ...
                <section class="footer-col">
                    ...
                    <ul class="footer-list">
                        ...
                        <li><a href="{{ url('/guides/requirements') }}">Guide requirements (just be local, really)</a>
                        </li>
                ...
                <section class="footer-col">
                    ...
                    <ul class="footer-list">
                        ...
                        <li><a href="{{ url('/blog/first-tour-expectations') }}">What to expect on your first tour</a>
                        </li>
                ...
                <section class="footer-col">
                    ...
                    <div class="footer-contact-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <div>
                            <div>Location</div><a href="{{ url('/contact') }}">Cebu, Philippines</a>
                        </div>
                    </div>
                </section>
