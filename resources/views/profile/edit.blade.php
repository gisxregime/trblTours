...
<body>
    ...
    <div class="profile-shell" data-profile-editor data-start-editing="{{ count($errors) > 0 ? '1' : '0' }}">
        <div class="profile-cover" id="coverPreview"
            @if ($coverPhotoUrl) style="background-image: url('{{ $coverPhotoUrl }}');" @endif>
            <div class="profile-top-actions">
                <a href="{{ $dashboardUrl }}" class="pill-link">&larr; Back</a>
            </div>
        </div>
            ...
            <section class="identity-card">
                ...
                <div class="avatar-wrap">
                    <div class="avatar" id="profilePreview"
                        @if ($profilePhotoUrl) style="background-image: url('{{ $profilePhotoUrl }}');" @endif>
                        @if (!$profilePhotoUrl)
                ...
                <h1 class="identity-name" id="identityName">{{ $displayName }}</h1>
            </section>
                    ...
                    <div class="fields">
                        <div class="field-grid">
                            <div class="field">
                                ...
                                <input id="full_name" name="full_name" type="text"
                                    value="{{ old('full_name', $user->full_name ?: $user->name) }}" class="field-input"
                        ...
                        <div class="field">
                            ...
                            <textarea id="bio" name="bio" class="field-textarea" data-editable="true" disabled
                                placeholder="Share your favorite trips, interests, or travel style.">{{ old('bio', $user->bio) }}</textarea>
                            @error('bio')
                                <p class="error-text">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input id="region" name="region" type="text"
                                value="{{ old('region', $user->region) }}" class="field-input" data-editable="true"
